...
export default function Footer(){
    ...
    return(
        ...
        <div className="footer grow container-sm *: flex flex-col items-center sm:items-start  gap-12 sm:gap-8  text-amber-50 pt-15 sm:grid grid-cols-3">
        ...
        <div className=" bg-black w-full grow text-white  col-start-1 -col-end-1 text-center py-3  capitalize text-[15px]">
                <p className="">
